...
- Teachers can create exams with MCQ and coding questions, where teacher can also provide the pin for the examination which they have created for secure access.
- Exam management for teachers, including question creation and configuration.

### Student Functionality

- Students can view available exams and participate in them by using the key provided by the teacher.
- The test page displays questions and a timer with an auto-submit feature.

### AI Exam Proctoring

- Real-time AI proctoring of students during exams.
- AI checks for cheating behaviors, such as mobile phone detection, multiple faces detection,eye movements , background voice , and absence of detected faces.
- Cheating incidents are logged and viewable by teachers in their dashboard.
- it also has the browser locking system so tat no tabs can be change.
